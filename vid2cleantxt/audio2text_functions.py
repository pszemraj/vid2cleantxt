...
def validate_output_directories(directory, t_folder_name="v2clntxt_transcriptions",
...
def quick_keys(filename, filepath, max_ngrams=3, num_keywords=20, save_db=False, verbose=False, txt_lang='en',
               ddup_thresh=0.3):
